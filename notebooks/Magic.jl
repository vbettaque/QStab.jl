...
begin
	data_2_100 = CSV.read("../data/magic/transverse_sk/sk_N2J1g10s10000i100.csv", DataFrame)
	data_3_100 = CSV.read("../data/magic/transverse_sk/sk_N3J1g10s10000i100.csv", DataFrame)
	data_4_100 = CSV.read("../data/magic/transverse_sk/sk_N4J1g10s10000i100.csv", DataFrame)
	data_5_100 = CSV.read("../data/magic/transverse_sk/sk_N5J1g10s10000i100.csv", DataFrame)
	data_6_100 = CSV.read("../data/magic/transverse_sk/sk_N6J1g10s10000i100.csv", DataFrame)
end
...
manifest_format = "2.0"
project_hash = "634a48963b56280eb5f39f8e2b79f26e5095f47e"
